...
export const TodoForm = ({ initialData, onSubmit, onCancel }: TodoFormProps) => {
    const defaultState = { name: '', description: '', dueDate: '' }
    const [formData, setFormData] = useState<Partial<Todo>>(initialData || defaultState)
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <div className="pt-4">
                    <Button
                        ...
                        className={`w-full text-lg py-3 ${!isFormValid ? 'opacity-50 cursor-not-allowed' : ''
                            }`}
                    >
